...
public class CircleImageView extends ImageView {
    ...
    public static final int DEFAULT_DRAWABLE_SIZE = (int) (Resources.getSystem().getDisplayMetrics().density * 40);
    ...
    public boolean isCircleBackgroundEnabled() {
    ...
    public void setProgressStokeWidth(int mProgressStokeWidth) {
        this.mProgressStokeWidth = mProgressStokeWidth;
    }

    public void setInnerRadius(int mInnerRadius) {
